...
export default function Home(props) {
  const { categorias, latestProducts } = props;
  ...
  return (
    <>
      ...
      <section className={styles.infoContainer}>
        <h1>
          No es comida rápida, <b>es comer sin perder el tiempo.</b>
        </h1>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.content}>
            ...
            <p>
              No pierdas 1 hora y media a la semana (para que después gran parte
              de la compra termine en la basura)
            </p>
          </div>
        </div>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.content}>
            ...
            <p>
              Hacerlo de vez en cuando tampoco está mal. Pero vamos.... todos
              los días NO
            </p>
          </div>
        </div>
      ...
      <section className={styles.category}>
        ...
        <div className={styles.boxContainer}>
          {categorias.map((categoria) => (
            <Link href={`/productos?cat=${categoria.id}`} key={categoria.id}>
      ...
      <section className={styles.products}>
        ...
        <div className={styles.boxContainer}>
          {latestProducts && latestProducts.map((producto) => (
